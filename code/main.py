...
if __name__ == "__main__":
    ...
    frames = glob.glob('/Users/anishasingrodia/Desktop/CIS_580/HW2/hw2_code/data/frames/*.jpg')
    print(frames)
    frames.sort()
    images = [np.array(imageio.imread(f)) for f in frames]

    # extrinsic
    corners = np.load('/Users/anishasingrodia/Desktop/CIS_580/HW2/hw2_code/data/corners.npy')
    ...
    drill_mesh = trimesh.load("/Users/anishasingrodia/Desktop/CIS_580/HW2/hw2_code/data/models/drill.obj")
    fuze_mesh = trimesh.load("/Users/anishasingrodia/Desktop/CIS_580/HW2/hw2_code/data/models/fuze.obj")
